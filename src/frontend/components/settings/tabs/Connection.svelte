<script lang="ts">
    ...
    import { activePage, activePopup, activeShow, activeTriggerFunction, capabilities, cloudSyncData, companion, connections, contentProviderData, disabledServers, maxConnections, notFound, obsData, outputs, popupData, ports, projectTemplates, providerConnections, saved, serverData, special } from "../../../stores"
